...
async function getuserInfoRealtime(userID){
    ...
    <link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
        ...
        <h3 style="text-align: center; color: black"><a href="https://wwwadmin.netlify.app/">Redirect to activities <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a></h3>
        </div>
