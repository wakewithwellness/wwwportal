                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 style="color: #fff;text-align: center;">WEEKLY ATTENDANCE</h1>
                          ...
                          <h5 style="color: white;font-weight: 200;font-size:13px;text-align:left">I, <span style="color:#009efb;font-weight:400;font-size:14px">${userInfo.name} [${userInfo.regno}]</span> post my attendance for the <span style="font-weight: 500;">month of June</span> <span style="font-size: 14px;color: #009efb;">[01/06/2022 - 15/06/2022]</span></h5>
                          <br><label>Works:</label>
                        <textarea id="work" maxlength="300" style="padding: 1px;color:white" placeholder="Mark your attendance before 30th june for the month of JUNE 2022"  required ></textarea>
...
function updateattendance(event){
  ...
  var Jun1 = document.getElementById('attend').value
  var Jun1f = document.getElementById('work').value
 ...
 document.getElementById('attendanceform').reset();
     ...
     var countDownDate = new Date("June 30, 2022 22:00:00").getTime();
