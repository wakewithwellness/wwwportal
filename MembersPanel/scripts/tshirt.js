...
var dataRef = firebase.database().ref('tshirts');
...
function submitForm(e){
  ...
  // Save message
  saveData(Membername, Email, address, type,size,tname);
...
function saveData(Membername, Email, address, type, size,tname){
  ...
  newDataRef.set({
    ...
    tname:tname,
     ...
     var countDownDate = new Date("November 25, 2022 23:59:00").getTime();
