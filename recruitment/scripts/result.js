...
function createUserCollection(user) {
  firebase.firestore().collection("test").doc(user.uid).set({
    uid: user.uid,
...
<br><br><br>
          ...
          <p style="font-size:13px; margin-left:10px;color:white;text-align:justify">${userInfo.q1}</p>
          </div>
          </div>
          <div class="col-lg-6 my-2">
          <div style="background-color:#2E3035;padding:15px;border-radius:10px">
          ...
          <p style="font-size:13px; margin-left:10px;color:white;text-align:justify">${userInfo.q2}</p>
          </div>
          </div>
          </div>
          ...
          <p style="font-size:13px; margin-left:10px;color:white;text-align:justify">${userInfo.q3}</p>
          </div>
          </div>
          <div class="col-lg-6 my-2">
          <div style="background-color:#2E3035;padding:15px;border-radius:10px">
          <label style="font-size:13px;color:#A9A9A9">QUESTION 4 OF 5</label><br>
          <label for="q4" style="font-size:14px;color:#FFB145">How would you deal with daily setbacks?</label>
          <p style="font-size:13px; margin-left:10px;color:white;text-align:justify">${userInfo.q4}</p>
          </div>
          </div>
          </div>
          ...
          <label for="q5" style="font-size:14px;color:#FFB145">Which other recruitment companies have you applied for jobs with?</label>
          <p style="font-size:13px; margin-left:10px;color:white;text-align:justify">${userInfo.q5}</p>
          </div>
          </div>
          <div class="col-lg-6 my-2">
