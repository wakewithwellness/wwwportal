        ...
        if (userInfo) {
          ...
          <div class="row">
                    ...
                    <div style="text-align:left">
                        ...
                        <div class="form-group row">
                        <label class="col-form-label col-2"><img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" style="width:25px" alt="whatsapp"/></label>
                        <div class="col-10">
                            <input type="tel" id="ins" placeholder="Paste the link here" style="background-color:#313438;border: 1.5px solid #242629;color:white;" class="form-control" >
                        </div>
                        </div>

                        <div class="form-group row">
                        <label class="col-form-label col-2"><img src="https://cdn-icons-png.flaticon.com/512/174/174848.png" style="width:25px" alt="whatsapp"/></label>
                        <div class="col-10">
                            <input type="tel" id="fb" placeholder="Paste the link here" style="background-color:#313438;border: 1.5px solid #242629;color:white;" class="form-control" >
                        </div>
                        </div>

                        <div class="form-group row">
                        <label class="col-form-label col-2"><img src="https://cdn-icons-png.flaticon.com/512/3256/3256013.png" style="width:25px" alt="whatsapp"/></label>
                        <div class="col-10">
                            <input type="tel" id="tr" placeholder="Paste the link here" style="background-color:#313438;border: 1.5px solid #242629;color:white;" class="form-control" >
                        </div>
                        </div>

                        <div class="form-group row">
                        <label class="col-form-label col-2"><img src="https://cdn-icons-png.flaticon.com/512/3536/3536505.png" style="width:25px" alt="whatsapp"/></label>
                        <div class="col-10">
                            <input type="tel" placeholder="Paste the link here" id="ln" style="background-color:#313438;border: 1.5px solid #242629;color:white;" class="form-control" >
                        </div>
                        </div>
            ...
            <div class="row">
                  ...
                  <div class="col-auto"> 
                     <button type="submit" class="btn" style="border:none;min-width:100px;margin-top:-2px;background-color: #3C9E65;color:white;font-weight:bold;">Confirm</button>
                        ...
                        document.getElementById("ins").value = userInfo.ins
                        document.getElementById("fb").value = userInfo.fb
                        document.getElementById("tr").value = userInfo.tr
                        document.getElementById("ln").value = userInfo.ln
