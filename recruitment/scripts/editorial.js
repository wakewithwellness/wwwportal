...
<br>
                                                ...
                                                <div id="div1" class="hide" style="visibility: hidden;color:red;display:${userInfo.t1}">
                                                ${userInfo.t1}
                                                </div>
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">Q5</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 6 OF 6</label><br>
                                            <label for="q6" style="font-size:14px;color:#fff">Q6</label>
