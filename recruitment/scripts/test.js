      ...
      if (doc.exists) {
        ...
        if (userInfo) {
          userDetails.innerHTML = `
                        ...
                        <div class="content" style="background-color: #4f4f4f; margin-top:-30px;padding-right:20px; color:white">
              ...
              <h4 style="color:rgba(255, 102, 0, 0.939)">Recruitment Test 2023</h4><hr><br>
                      ...
                      <hr><button onclick="location.href='./result.html'" class="btn btn-secondary"><i class="fa fa-bookmark" aria-hidden="true"></i> See Answers</button>
                       ...
                       <div class="text-center">
                            <h5 style="color: red; padding:7px;">Your time is up! Please contact our technical team.</h5>
                       </div>
