...
<br>
<div style="color:yellow;display:${userInfo.t6}">
Please wait...
 </div>

                                                <button onclick="muyh()" class="btn" style="background-color:#13C15C;min-width:120px;display:${userInfo.test6}" >
                    ...
                    <div id="qui" style="display:none">
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">What softwares do you use for designing, list them?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 6 OF 6</label><br>
                                            <label for="q6" style="font-size:14px;color:#fff">Write about your design background and why did you choose to be a designer?</label>
                      ...
                      <hr><button onclick="location.href='result/design.html'" style="background-color:#13C15C; color:white" class="btn"><i class="fa fa-bookmark" aria-hidden="true"></i> See Result</button>
                      </div>
...
function updatestartbtn(event) {
  ...
  var test6 = document.getElementById("btnstartdisplay").value;
  var t6 = document.getElementById("texttdisplay").value;
