...
<br>
<div style="color:yellow;display:${userInfo.t4}">
Please wait...
 </div>

                                                <button onclick="muyh()" class="btn" style="background-color:#13C15C;min-width:120px;display:${userInfo.test4}" >
                    ...
                    <div id="qui" style="display:none">
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">What are your thoughts on Marketing department for the organisation to grow more and have more outreach? </label>
                      ...
                      <hr><button onclick="location.href='result/marketing.html'" style="background-color:#13C15C; color:white" class="btn"><i class="fa fa-bookmark" aria-hidden="true"></i> See Result</button>
                      </div>
...
function updatestartbtn(event) {
  ...
  var test4 = document.getElementById("btnstartdisplay").value;
  var t4 = document.getElementById("texttdisplay").value;
