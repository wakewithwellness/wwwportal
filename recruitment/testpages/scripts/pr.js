...
<br>
<div style="color:yellow;display:${userInfo.t3}">
Please wait...
 </div>

                                                <button onclick="muyh()" class="btn" style="background-color:#13C15C;min-width:120px;display:${userInfo.test3}" >
                    ...
                    <div id="qui" style="display:none">
                             ...
                             <div class="row">
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 1 OF 6</label><br>
                                         <label for="q1" style="font-size:14px;color:#fff">What do you think, are your skills to be a match for the desired position?</label>
                                         <textarea minlength="50" style="background-color:#2E3035;color:white;border:none;font-size:12px" class="form-control" id="q1" rows="7" required></textarea>
                                       </div>
                   
                                       <div class="form-group">
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                            <label for="q2" style="font-size:14px;color:#fff">How can your skills and comprehension, make a significant contribution to the specific department?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 3 OF 6</label><br>
                                            <label for="q3" style="font-size:14px;color:#fff">Do you have any work experiences volunteering for your desired sector, and if not, what are your ideas to set forth for the upliftment of the sector?                                                   </label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 4 OF 6</label><br>
                                            <label for="q4" style="font-size:14px;color:#fff">What's the most challenging part about working in community outreach, and how can you lend your helping hand for its success?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">Why do you want to be part of the PR team?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 6 OF 6</label><br>
                                            <label for="q6" style="font-size:14px;color:#fff">PR team needs a sponsor for an event, and you have been entrusted for getting hold of a sponsor, how will you proceed with the same?</label>
                      ...
                      <div class="modal-dialog">
                        ...
                        <p style="font-size:14px; color:#CECECE">If you want to end the test and submit your answers you can press confirm button.</p>
                          ...
                          <div class="text-center">
                          <button onclick="history.back()" class="btn" style="width:100px;margin-top:-2px;background-color:#949494;font-size:13px" >
                          <span style="color:white;font-weight:bold;">CANCEL</span>
                          </button> 
                      ...
                      <hr><button onclick="location.href='result/pr.html'" style="background-color:#13C15C; color:white" class="btn"><i class="fa fa-bookmark" aria-hidden="true"></i> See Result</button>
                      </div>
...
function updatestartbtn(event) {
  ...
  var test3 = document.getElementById("btnstartdisplay").value;
  var t3 = document.getElementById("texttdisplay").value;
