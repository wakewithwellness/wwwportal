...
<br>
<div style="color:yellow;display:${userInfo.t1}">
Please wait...
 </div>

                                                <button onclick="muyh()" class="btn" style="background-color:#13C15C;min-width:120px;display:${userInfo.test1}" >
                    ...
                    <div id="qui" style="display:none">
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">How do you stay motivated with repetitive tasks like proofreading, fact-checking or source-checking?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 6 OF 6</label><br>
                                            <label for="q6" style="font-size:14px;color:#fff">What would you do if you or a member of your team made a very public error or created a PR crisis? How would you handle it?</label>
                      ...
                      <hr><button onclick="location.href='result/editorial.html'" style="background-color:#13C15C; color:white" class="btn"><i class="fa fa-bookmark" aria-hidden="true"></i> See Result</button>
                      </div>
...
function updatestartbtn(event) {
  ...
  var test1 = document.getElementById("btnstartdisplay").value;
  var t1 = document.getElementById("texttdisplay").value;
