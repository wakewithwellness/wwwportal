...
<br>
<div style="color:yellow;display:${userInfo.t2}">
Please wait...
 </div>

                                                <button onclick="muyh()" class="btn" style="background-color:#13C15C;min-width:120px;display:${userInfo.test2}" >
                    ...
                    <div id="qui" style="display:none">
                      ...
                      <hr><button onclick="location.href='result/curation.html'" style="background-color:#13C15C; color:white" class="btn"><i class="fa fa-bookmark" aria-hidden="true"></i> See Result</button>
                      </div>
...
function updatestartbtn(event) {
  ...
  var test2 = document.getElementById("btnstartdisplay").value;
  var t2 = document.getElementById("texttdisplay").value;
