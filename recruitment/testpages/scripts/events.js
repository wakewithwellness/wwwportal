...
<br>
<div style="color:yellow;display:${userInfo.t5}">
Please wait...
 </div>
                                  ...
                                  <div class="col-lg-8" >
                                       ...
                                       <label style="font-size:13px;color:#A9A9A9">QUESTION 2 OF 6</label><br>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 5 OF 6</label><br>
                                            <label for="q5" style="font-size:14px;color:#fff">What would you do in a situation where the host of the event is late by 30 minutes and the audience are creating chaos due to the delay in the start of the event?</label>
                                          ...
                                          <label style="font-size:13px;color:#A9A9A9">QUESTION 6 OF 6</label><br>
                                            <label for="q6" style="font-size:14px;color:#fff">What are your competencies to work as a member/Co-ordinator of the events department?</label>
