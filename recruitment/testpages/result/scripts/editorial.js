...
<div style="display:${userInfo.r}">
                  ...
                  <label for="q5" style="font-size:14px;color:#FFB145">How do you stay motivated with repetitive tasks like proofreading, fact-checking or source-checking?</label>
                  ...
                  <label for="q6" style="font-size:14px;color:#FFB145">What would you do if you or a member of your team made a very public error or created a PR crisis? How would you handle it?</label>
