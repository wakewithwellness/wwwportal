...
<div style="display:${userInfo.r}">
              ...
              <label for="q5" style="font-size:14px;color:#FFB145">What softwares do you use for designing, list them?</label>
              ...
              <label for="q6" style="font-size:14px;color:#FFB145">Write about your design background and why did you choose to be a designer?</label>
