...
<div style="display:${userInfo.r}">
                    ...
                    <label for="q5" style="font-size:14px;color:#FFB145">Why do you want to be part of the PR team?</label>
                    ...
                    <label for="q6" style="font-size:14px;color:#FFB145">PR team needs a sponsor for an event, and you have been entrusted for getting hold of a sponsor, how will you proceed with the same?</label>
