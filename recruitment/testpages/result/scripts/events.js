...
<div style="display:${userInfo.r}">
          ...
          <label for="q5" style="font-size:14px;color:#FFB145">What would you do in a situation where the host of the event is late by 30 minutes and the audience are creating chaos due to the delay in the start of the event?</label>
          ...
          <label for="q6" style="font-size:14px;color:#FFB145">What are your competencies to work as a member/Co-ordinator of the events department?</label>
