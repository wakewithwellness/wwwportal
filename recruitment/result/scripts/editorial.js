...
function createUserCollection(user) {
  firebase.firestore().collection("trialeditorial").doc(user.uid).set({
    uid: user.uid,
...
<br><br><br>
          ...
          <div class="col">
            <div onclick="location.href='../editorial.html'" style="cursor:pointer;background: linear-gradient(to right, #fb5444 0%, #feb645 100%);padding:5px;text-align:center;border-radius:10px">
...
<label for="q1" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
...
<label for="q2" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
...
<label for="q3" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
...
<label for="q4" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
...
<label for="q5" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
...
<label for="q6" style="font-size:14px;color:#FFB145">This is practise session write anything you want...</label>
