...
function createUserCollection(user) {
  firebase.firestore().collection("editorial").doc(user.uid).set({
    uid: user.uid,
...
<br>
          ...
          <div class="container">
          <h6 style="color:white">Result <i style="color:grey">(Editorial Dept.)</i>:</h6>
          <div class="container" style="max-width:180px;float:left;background: linear-gradient(to right, #fc5344 0%, #ffb645 100%);padding:5px;text-align:center;border-radius:10px">
...
<br><br><br>
          ...
          <div class="container" style="max-width:180px;float:left;background-color: #fc5344;padding:5px;text-align:center;border-radius:10px;display:${userInfo.show}">
          <h6 style="font-weight:bold;color:white;margin-top:5px">Test not attended</h6>
        </div>

     

        <div onclick="location.href='../editorial.html'" class="container" style="cursor:pointer;max-width:180px;float:left;margin-left:12px;background: linear-gradient(to right, #148E00 0%, #36C113 100%);padding:5px;text-align:center;border-radius:10px;display:${userInfo.show}">
        <h6 style="font-weight:bold;color:white;margin-top:5px">Attend the Test</h6>
      </div>
...
<div style="display:${userInfo.r}">
          ...
          <label for="q1" style="font-size:14px;color:#FFB145">Why do you want to work in recruitment?</label>
          ...
          <label for="q2" style="font-size:14px;color:#FFB145">What do you think is key to a successful career in recruitment?</label>
          ...
          <label for="q3" style="font-size:14px;color:#FFB145">How would you go about generating new business?</label>
          ...
          <label for="q4" style="font-size:14px;color:#FFB145">What would you do in a situation where the host of the event is late by 30 minutes and the audience are creating chaos due to the delay in the start of the event?</label>
          ...
          <label for="q5" style="font-size:14px;color:#FFB145">What are your competencies to work as a member/Co-ordinator of the events department?</label>
          ...
          <label for="q6" style="font-size:14px;color:#FFB145">What would you do in a situation where it was free registration and the no. of audience turned out to be more than the expected count and now your team is facing a shortage in the food packets?</label>
