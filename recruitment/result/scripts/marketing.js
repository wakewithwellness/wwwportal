...
<br><br><br>
        ...
        <div onclick="location.href='../marketing.html'" class="container" style="cursor:pointer;max-width:180px;float:left;margin-left:12px;background: linear-gradient(to right, #148E00 0%, #36C113 100%);padding:5px;text-align:center;border-radius:10px;display:${userInfo.show}">
