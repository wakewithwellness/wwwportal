...
function createUserCollection(user) {
  firebase.firestore().collection("trialcuration").doc(user.uid).set({
    uid: user.uid,
...
<br><br><br>
          ...
          <div class="col">
            <div onclick="location.href='../curation.html'" style="cursor:pointer;background: linear-gradient(to right, #fb5444 0%, #feb645 100%);padding:5px;text-align:center;border-radius:10px">
