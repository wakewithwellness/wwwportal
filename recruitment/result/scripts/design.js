...
function createUserCollection(user) {
  firebase.firestore().collection("design").doc(user.uid).set({
    uid: user.uid,
...
<br>
          ...
          <div class="container">
          <h6 style="color:white">Result <i style="color:grey">(Design & Media Dept.)</i>:</h6>
...
<br><br><br>
        ...
        <div onclick="location.href='../design.html'" class="container" style="cursor:pointer;max-width:180px;float:left;margin-left:12px;background: linear-gradient(to right, #148E00 0%, #36C113 100%);padding:5px;text-align:center;border-radius:10px;display:${userInfo.show}">
