...
async function getuserInfo(userID) {
  if (userID) {
    ...
    Atten.innerHTML = ` <div class="container" style="max-width: 80vh;margin-top:180px">
...
function updateattendance(event) {
  ...
  var setWithMerge = userRef
    ...
    .catch((err) => {
      console.log(err);
      M.toast({
        html: `<div><i style="font-size: 20px" class="fa fa-exclamation-triangle" aria-hidden="true"></i>Error ! Feedback not submitted</div>`,
        classes: "red",
      });
    });
}
