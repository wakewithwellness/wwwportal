...
<div class="container" style="background-color: #fff;border-top: 3px solid #03b1fc;padding: 20px;border-radius:5px; margin-top:8vh">
<div class="row">
<div class="col-sm-12">
    <h4 class="page-title">WWW Coordinator Details</h4><hr>
</div>
</div>
<div class="row">
<div class="col-lg">
<h6 style="color: grey">Name: <strong style="color: #03b1fc">${userInfo.name}</strong> </h6>
</div>
<div class="col-lg">
<h6 style="color: grey">Registration no.: <strong style="color: #03b1fc">${userInfo.regno}</strong></h6>
</div>
</div>
</div>
            ...
            <div class="container" style="background-color: #fff;border-top: 3px solid #03b1fc;border-radius:5px;margin-top:2vh">
            ...
            <div class="container" style="background-color: #fff;border-top: 3px solid #03b1fc;padding: 20px;border-radius:5px; margin-top:2vh">
                    <div class="row">
                    <div class="col-sm-12">
                    ...
                    <div class="row">
                    <div class="col-lg"><br>
                    <h5 style="background-color:#03b1fc;color:white;padding:8px;margin-bottom:12px">Pass 1</h5>
                    ...
                    <h5 style="background-color:#03b1fc;color:white;padding:8px;margin-bottom:12px">Pass 2</h5>
                    ...
                    <h5 style="background-color:#03b1fc;color:white;padding:8px;margin-bottom:12px">Pass 3</h5>
