                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h1 style="color: cornflowerblue;text-align: center;">WEEKLY ATTENDANCE</h1>
                          ...
                          <h4 style="color: rgb(173, 137, 137);font-weight: 200;">I, <span style="color:red;font-weight:500">${userInfo.name} [${userInfo.regno}]</span> post my attendance for the <span style="font-weight: 500;">First half of June</span> <span style="font-size: 14px;color: tomato;">[01/06/2022 - 15/06/2022]</span></h4>
...
function updateattendance(event){
   ...
   document.getElementById('attendanceform').reset();
     ...
     var countDownDate = new Date("June 15, 2022 22:00:00").getTime();
